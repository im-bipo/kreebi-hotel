        ...
        <>
            <div className='bg-stdBgOne px-3 pb-20 md:pt-20 flex flex-col md:flex-row'>
                <div className='flex flex-col max-w-lg m-auto md:w-1/2 md:pl-5'>
                    <div className='my-10'>
                        <RiHotelBedFill className='text-primary text-[4rem] rounded-lg border border-gray-300  p-2' />
                    </div>
                ...
                <div className='w-full h-[30rem] rounded-[2rem]  shadow-lg max-w-lg m-auto md:w-1/2 '>
                    ...
                    <div id="bookingP" className='flex justify-end'>
                        <div id="BoolingPCard" className='w-fit  px-6 rounded-lg bg-gray-50 shadow-lg relative z-10 bottom-64 h-40 text-center text-gray-600  right-3 lg:left-5'>
